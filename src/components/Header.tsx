        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#086E0A] focus:border-transparent transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            >
              ...
              {cartItemsCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-[#086E0A] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                  {cartItemsCount}
                </span>
              )}
            </button>
        ...
        <div className="md:hidden pb-4">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search shoes..."
              className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#086E0A] focus:border-transparent"
            />
          </div>
        </div>
